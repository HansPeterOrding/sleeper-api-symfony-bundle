...
INSERT INTO public.sasb_sleeper_player (
    player_id, first_name, last_name, age, team, number, status, active,
    position, fantasy_positions, depth_chart_position, deptch_chart_order,
    weight, height, high_school, college, birth_date, birth_city,
    birth_state, birth_country, years_exp, espn_id, fantasy_data_id,
    gsis_id, pandascore_id, rotowire_id, rotoworld_id, sportradar_id,
    stats_id, injury_status
) VALUES {$valuesSql}
