...
use HansPeterOrding\SleeperApiSymfonyBundle\Message\SleeperSync\SyncSleeperRostersBatchMessage;
use Psr\Log\LoggerInterface;
use Symfony\Component\Messenger\Attribute\AsMessageHandler;

#[AsMessageHandler]
class SyncSleeperRostersBatchHandler
{
    ...
    public function __invoke(SyncSleeperRostersBatchMessage $message): void
    {
        if ($message->rosters === []) {
            return;
        }
        ...
        try {
            ...
            $this->db->rollBack();
            $this->logger->warning('SyncSleeperRostersBatchHandler transient error', [
